      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="py-14">
          <div className="container lg:w-9/12 mx-auto">
            <h2 className="text-4xl text-gray-600 mb-10 font-medium">
              Sign Up
            </h2>
            <form onSubmit={handleLogin}>
              ...
              <div className="flex w-full items-center gap-4 my-4">
                <div className="w-full">
                  ...
                  <input
                    className="block w-full py-[11px] px-4 focus:outline-none border focus:ring-2 focus:ring-gray-400 focus:border-gray-500 transition duration-300 rounded"
                    type="text"
                    name="fname"
                ...
                <div className="w-full">
                  ...
                  <input
                    className="block py-[11px] w-full px-4 focus:outline-none border focus:ring-2 focus:ring-gray-400 focus:border-gray-500 transition duration-300 rounded"
                    type="text"
                    name="lname"
              ...
              <div className="relative my-4">
                ...
                <span
                  ...
                  className="absolute top-1/2 right-3 mt-1 cursor-pointer"
                >
                  {showPassword ? (
                    <svg
              ...
              <div className="w-full mt-4">
                <button className="bg-[#19A526] text-white font-medium w-full py-3 hover:bg-[#006838] transition duration-300 rounded-full">
                  Sign Up
                </button>
              </div>
            </form>
            ...
            <div className="w-full mt-2">
              <div className="md:flex justify-between gap-4 items-center">
                <button className="border mb-4 md:mb-0 flex items-center gap-2 rounded px-4 w-full py-[10px] focus:ring-2 focus:ring-gray-400 focus:border-gray-500 transition duration-300">
